...
sys_exit.o: ${S}/syscall/sys_exit.c
	${COMPILE.c} ${S}/syscall/sys_exit.c
SRCS+=${S}/syscall/sys_exit.c
OBJS+=sys_exit.o
...
timeslice.o: ${S}/thread/timeslice.c
	${COMPILE.c} ${S}/thread/timeslice.c
SRCS+=${S}/thread/timeslice.c
OBJS+=timeslice.o
