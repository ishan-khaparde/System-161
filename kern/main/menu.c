...
common_prog(int nargs, char **args)
{
	...
	result = thread_fork_userthread(args[0] /* thread name */,
...
menu(char *args)
{
	...
	while (1) {
	        kprintf("MULTI LEVEL FEEDBACK QUEUE SCHEDULER\n");
		kprintf("Swapfile : lhd0raw, file1 ! \n");
		kprintf("LRU Paging & TLB Algorithm \n");
